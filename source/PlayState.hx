	...
	override public function create()
	{
			...
			case 'stage': //Week 1
				...
				if(!ClientPrefs.lowQuality) {
					...
					add(stageCurtains);
                        ...
                        case 'colas':
				bgcolas:BGSprite = new BGSprite('colas/stageback', -600, -200, 0.9, 0.9);
				add(bg);
		...
		switch(Paths.formatToSongPath(SONG.song))
		{
			case 'stress':
                ...
                {
                        case 'beta':
                                GameOverSubstate.characterName = 'beta';
                        case 'blue':
                                GameOverSubstate.characterName = 'blue';
                        case 'mean':
                                GameOverSubstate.characterName = 'mean';
                }
